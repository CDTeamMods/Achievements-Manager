...
class SettingsManager {
    ...
    try {
      ...
      if (settings.setupComplete === void 0) {
        const hasPriorConfig =
          ...
          settings.liteMode !== void 0 ||
          settings.virtualScrolling !== void 0 ||
          settings.apiSource !== void 0 ||
          settings.cacheSize !== void 0;
  ...
  get(key) {
    const settings =
      this.app.modules.state && this.app.modules.state.getState
        ? this.app.modules.state.getState('settings') || {}
        : {};
    return settings[key];
  }
  getAll() {
    return this.app.modules.state && this.app.modules.state.getState
      ? this.app.modules.state.getState('settings') || {}
      : {};
  }
  async set(key, value) {
  ...
  applyVirtualScrolling(virtualScrolling) {
    ...
    const isVirtualScrolling =
      virtualScrolling !== void 0 ? virtualScrolling : settings.virtualScrolling;
  ...
  async applyLanguage(language, showNotification = true) {
    ...
    if (success) {
      if (
        this.app.modules.state &&
        this.app.modules.state.getState &&
        this.app.modules.state.setState
      ) {
