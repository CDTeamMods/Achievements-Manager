...
var require_performance = __commonJS({
  "src/main/modules/performance.js"(exports, module) {
    ...
    class PerformanceManager {
      ...
      static {
        __name222(this, "PerformanceManager");
      }
      static {
        __name2222(this, "PerformanceManager");
      }
      static {
        __name22222(this, "PerformanceManager");
      }
      static {
        __name222222(this, "PerformanceManager");
      }
      constructor(store) {
        this.store = store;
        this.metrics = {
    ...
    __name222(setupPerformance, "setupPerformance");
    __name2222(setupPerformance, "setupPerformance");
    __name22222(setupPerformance, "setupPerformance");
    __name222222(setupPerformance, "setupPerformance");
    module.exports = { PerformanceManager, setupPerformance };
  }
});
var performance_default = require_performance();
export {
