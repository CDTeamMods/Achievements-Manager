...
var require_steam_integration = __commonJS({
  "src/main/modules/steam-integration.js"(exports, module) {
    ...
    class SteamIntegrationManager {
      ...
      static {
        __name22(this, "SteamIntegrationManager");
      }
      static {
      ...
      static {
        __name222222(this, "SteamIntegrationManager");
      }
      static {
        __name2222222(this, "SteamIntegrationManager");
      }
      static {
        __name22222222(this, "SteamIntegrationManager");
      }
      static {
        ...
        try {
          ...
          if (games.length > 0) {
            ...
            const result = {
              ...
              warning: isPrivateProfile ? "Biblioteca vazia ou perfil privado. Verifique se sua biblioteca de jogos est\xE1 p\xFAblica." : null
            };
            this.setCache("userGames", result);
            return result;
          }
      ...
      async getInstalledGamesOptimized(retryCount = 0) {
        ...
        try {
          ...
          const installedGames = allGames.filter(
            (game) => game.appid && game.name && game.name.trim() !== "" && installedAppIdsSet.has(game.appid)
          );
          ...
          if (gameDetails) {
            return {
              ...
              details: {
                ...
                screenshots: gameDetails.screenshots ? gameDetails.screenshots.map((s) => s.path_thumbnail) : []
              }
            };
          } else {
            return {
