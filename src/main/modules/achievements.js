...
var require_achievements = __commonJS({
  "src/main/modules/achievements.js"(exports, module) {
    ...
    class AchievementsManager {
      static {
        __name(this, "AchievementsManager");
      }
      static {
      ...
      static {
        __name222(this, "AchievementsManager");
      }
      static {
        __name2222(this, "AchievementsManager");
      }
      static {
        __name22222(this, "AchievementsManager");
      }
      static {
        __name222222(this, "AchievementsManager");
      }
      ...
      async initialize() {
        try {
          ...
          this.crashReporter.captureException(error, {
            ...
            extra: { timestamp: /* @__PURE__ */ (/* @__PURE__ */ new Date()).toISOString() }
          });
        }
      }
      async getStats() {
        ...
        try {
          ...
          const achievements = gameAchievements.map((achievement) => {
            ...
            return {
              ...
              unlockTime: userAchievement && (userAchievement.unlocktime || userAchievement.unlockTime) ? new Date(
          ...
          const result = {
            ...
            completionRate: achievements.length > 0 ? (achievements.filter((a) => a.unlocked).length / achievements.length * 100).toFixed(1) : 0,
            lastUpdated: /* @__PURE__ */ (/* @__PURE__ */ new Date()).toISOString()
          };
    ...
    __name222(setupAchievements, "setupAchievements");
    __name2222(setupAchievements, "setupAchievements");
    __name22222(setupAchievements, "setupAchievements");
    __name222222(setupAchievements, "setupAchievements");
    module.exports = { AchievementsManager, setupAchievements };
  }
});
var achievements_default = require_achievements();
export {
